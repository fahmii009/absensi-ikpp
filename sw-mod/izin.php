                        ...
                        <form class="form-add-izin" autocomplete="off">
                            ...
                            <div class="form-group basic mb-2">
                                <div class="input-wrapper">
                                    ...
                                    <select class="form-control custom-select" name="type" required>
                                        ...
                                        <option value="4/Dinas Luar Kota">WFH</option>
                                        <option value="5/Dinas Dalam Kota">Liputan</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group basic-boxed">
                                <div class="input-wrapper mb-1">
                                    ...
                                    <span class="small text-danger">Silahkan upload file, pastikan bukti foto/surat yang di Upload dengan Format harus JPG/JPEG, DOC atau PDF</span>
                            </div>
                    ...
                    <div class="modal-body">
                        <form class="form-edit-izin" autocomplete="off">
                            ...
                            <div class="form-group basic">
                                ...
                                <span class="small text-danger">pastikan bukti foto/surat yang di Upload dengan Format harus JPG, JPEG dan PDF</span>
                            </div>

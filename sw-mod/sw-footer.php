...
<footer class="text-muted text-center" style="display:none">
   <p>© 2024 - '.$year.' '.$site_name.' - Design By: <span id="credits"><a class="credits_a" target="_blank">R</a></span></p>
</footer>
<!-- ///////////// Js Files ////////////////////  -->
<!-- Jquery -->
...
<script type="text/javascript">
    ...
    if (radius < jarak){
          ...
          swal({title: 'Oops!', text:'Posisi Anda saat ini tidak didalam radius atau Jauh dari Radius! (Pastiin lokasinya, jangan boong ya)', icon: 'error', timer: 3000,});
        }else{

                    ...
                    <form id="update-profile">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="employees_code">Nomor Registrasi Pendaftaran</label>
                                <input type="text" class="form-control" id="employees_code" name="employees_code" value="'.$row_user['employees_code'].'" required>
                    ...
                    <form id="update-password">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="password" class="form-control" name="employees_password" ivalue="'.$row_passwor['employees_password'].'" style="background:#eeeeee">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>

...
echo'
    <section class="container_box">
      ...
      if(isset($_GET['from']) OR isset($_GET['to'])){
        ...
        <p>Status : '.$row['position_name'].'</p><br>
      ...
      $rowa =  $resulta->fetch_assoc();
        ...
        echo'
         <tr style="background:'.$background.';color:'.$warna.'">
            ...
            echo'
              <td class="text-center"><img src="https://ramaandhikay.my.id/absensi-ikp/sw-content/absent/'.$row_absen['picture_in'].'" width="80" height="80"></td>
              <td class="text-center">'.$row_absen['time_in'].'</td>';
            }
            ...
            echo'
              <td class="text-center"><img src="https://ramaandhikay.my.id/absensi-ikp/sw-content/absent/'.$row_absen['picture_out'].'" width="80" height="80"></td>
              <td class="text-center">'.$row_absen['time_out'].'</td>';
            }
            echo'
              <td>'.$durasi_kerja.'</td>
        ...
        echo'
         <tr style="background:'.$background.';color:'.$warna.'">
            ...
            if (date("l",mktime (0,0,0,$bulan,$d,$tahun)) == "Sunday" or date("l",mktime (0,0,0,$bulan,$d,$tahun)) == "Saturday"){
              if($row_absen['time_in'] ==''){
                echo'
                <td class="text-center" colspan="3">Weekend</td>';
              }
              else{
                echo'
                <td class="text-center">'.$row_absen['time_in'].'</td>
